...
# What observation.state carries. Six wide, not seven: SliderDroppedDataset removed
# slider.vel at training time, so the checkpoint never saw it. This is the one contract
# that differs from multi_task_dit, which trains on all seven.
STATE_NAMES: tuple[str, ...] = ARM_POS_KEYS
